...
namespace Week14Assessment.EmployeeDataSetTableAdapters {
...
SELECT EmployeeID, Name, Position, Hourly_Pay_Rate FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Week14Assessment.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Name, Position, Hourly_Pay_Rate\r\n FROM dbo.Employee\r\nwhere Nam" +
                "e Like \'%\' + @value + \'%\' ";
